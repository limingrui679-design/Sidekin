...
| Visual corpus | The verifier requires exactly 200 tag-based catalog lineages and all 1,000 named stage assets. The two 100-lineage audit passes together provide one visual QA result per lineage. | `ArtSources/PET_THEME_CATALOG.json`, `docs/LINEAGE_AUDIT.md`, `docs/EXPANSION_AUDIT.md`, `Scripts/verify-desktop.mjs` |
